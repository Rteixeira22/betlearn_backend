...
//Get Steps Routes
router.get("/", requireAPIKey, verifyJWT, stepsController.getSteps); // Get all steps
router.get("/:id", requireAPIKey, verifyJWT, stepsController.getStepById); // Get step by ID
router.get(
...
router.get("/user_challenge_step/:id_user/:id_challenge/:id_step", requireAPIKey, verifyJWT,  stepsController.getUserHasChallengesByUserAndChallengeId); // Get step by User ID and Challenge ID and Step ID
router.get("/step_video/:id_video", requireAPIKey, verifyJWT, stepsController.getStepByVideoId); // Get step by video ID
router.get("/step_bet/:id_bet", requireAPIKey, verifyJWT, stepsController.getStepByBetId); // Get step by bet ID
router.get("/step_view/:id_view", requireAPIKey, verifyJWT, stepsController.getStepByViewId); // Get step by step view ID
router.get(
...
//Create Step Routes
router.post("/", requireAPIKey, verifyJWT, authorize('admin'), stepsController.createNewStep); // Create a new step
router.post("/step_video", requireAPIKey, verifyJWT, authorize('admin'), stepsController.createNewVideo); // Create a new step Video
router.post("/step_bet", requireAPIKey, verifyJWT, authorize('admin'), stepsController.createNewStepBet); // Create a new step Bet
router.post("/step_view", requireAPIKey, verifyJWT, authorize('admin'), stepsController.createNewStepView); // Create a new step View
router.post("/step_questionnaire", requireAPIKey, verifyJWT, authorize('admin'), stepsController.createNewStepQuestionnaire); // Create a new step Questionnaire

//Update Step Routes
router.put("/progress_percentage/:id", requireAPIKey, verifyJWT, stepsController.updateStepProgress); // Update step progress by ID
router.put("/step_video/:id_video", requireAPIKey, verifyJWT, authorize('admin'), stepsController.updateStepVideo); // Update step Video by ID
router.put("/step_bet/:id_bet", requireAPIKey, verifyJWT, authorize('admin'), stepsController.updateStepBet); // Update step Bet by ID
router.put("/step_view/:id_view", stepsController.updateStepView); // Update step View by ID
router.put(
  "/step_questionnaire/:id_questionnaire",
  requireAPIKey, verifyJWT, authorize('admin'),
  stepsController.updateStepQuestionnaire
); // Update step Questionnaire by ID

//Delete Step Routes
router.delete("/:id", requireAPIKey, verifyJWT, authorize('admin'), stepsController.deleteStep); // Delete step by ID
